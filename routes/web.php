...
Route::group(['middleware' => 'auth'], function () {
	...
	//fakta transportasi
	Route::get('/api/chart-quarterly/{tahun}', [TransportasiController::class, 'chartQuarterly']);
	Route::get('/api/chart-stacked-percent', [TransportasiController::class, 'chartStackedPercent']);
